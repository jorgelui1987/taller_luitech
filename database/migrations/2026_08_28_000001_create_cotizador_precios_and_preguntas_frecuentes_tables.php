...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('preguntas_frecuentes')->insert([
            ...
            ['pregunta' => '¿Qué garantía tienen las reparaciones?', 'respuesta' => 'Todas nuestras reparaciones incluyen 30 días de garantía escrita, tanto en repuestos como en mano de obra.', 'orden' => 2, 'activo' => true, 'created_at' => now(), 'updated_at' => now()],
