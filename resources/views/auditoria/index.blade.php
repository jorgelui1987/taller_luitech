    ...
    <div class="card mb-4">
        <div class="card-body py-3">
            <form method="GET" class="row g-2 align-items-end">
                <div class="col-md-3">
                    <label for="filtro-accion" class="form-label mb-1">Acción</label>
                    <input type="text" id="filtro-accion" name="accion" class="form-control form-control-sm" placeholder="ej: activar_2fa" value="{{ request('accion') }}">
                </div>
                <div class="col-md-3">
                    <label for="filtro-usuario" class="form-label mb-1">Usuario</label>
                    <input type="text" id="filtro-usuario" name="usuario" class="form-control form-control-sm" placeholder="Nombre del usuario" value="{{ request('usuario') }}">
                </div>
                <div class="col-md-2">
                    <label for="filtro-desde" class="form-label mb-1">Desde</label>
                    <input type="date" id="filtro-desde" name="desde" class="form-control form-control-sm" value="{{ request('desde') }}">
                </div>
                <div class="col-md-2">
                    <label for="filtro-hasta" class="form-label mb-1">Hasta</label>
                    <input type="date" id="filtro-hasta" name="hasta" class="form-control form-control-sm" value="{{ request('hasta') }}">
                </div>
