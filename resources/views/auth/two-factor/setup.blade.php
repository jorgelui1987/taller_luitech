                    ...
                    @elseif($secret)
                        ...
                        <form action="{{ route('two-factor.confirmar') }}" method="POST" class="row g-3">
                            ...
                            <div class="col-md-8 mx-auto text-center">
                                <label for="codigo-2fa" class="form-label visually-hidden">Código de verificación</label>
                                <input type="text" id="codigo-2fa" name="codigo" class="form-control form-control-lg text-center"
