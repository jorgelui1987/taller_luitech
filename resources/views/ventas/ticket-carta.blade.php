...
/* ═══ BOLETA MEDIA CARTA: 21.6 cm ancho × 13.97 cm alto ═══
...
.col-productos{flex:1.6;min-width:0}
...
@media print{
 ...
 /* Página = media carta vertical (mitad superior de una hoja carta).
    La mitad inferior queda libre para la siguiente boleta. */
...
<div class="aviso">📄 Formato <b>MEDIA CARTA</b> (21.6 × 13.97 cm) · <b>1 sola boleta por impresión</b>. Una hoja carta completa rinde para <b>2 boletas</b>: imprime, corta por la mitad y reutiliza la otra mitad. El botón azul no se imprime.</div>
...
<button class="btn-print" onclick="window.print()">🖨️ Imprimir boleta (media carta)</button>
