...
body{font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.3;color:#000;width:72mm}
@page{size:72mm auto;margin:2mm}
.hdr{text-align:center}
.hdr .tienda{font-size:13px;font-weight:700}
.hdr .inf{font-size:10px;font-weight:600}
.hdr .nro{font-size:14px;font-weight:700;letter-spacing:0.5px}
.det{font-size:11px;font-weight:600}
.det .etq{font-size:9px;font-weight:700}
.prod{width:100%;border-collapse:collapse;font-size:10px;table-layout:fixed}
.prod th{font-size:9px;text-align:left;font-weight:700;border-bottom:1.5px solid #000;text-transform:uppercase}
...
.prod td.d{font-size:9px;color:#555;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.prod th:nth-child(1){width:55%}
.prod th:nth-child(2){width:12%}
.prod th:nth-child(3){width:16%}
.prod th:nth-child(4){width:17%}
.tot .l{display:flex;justify-content:space-between;font-size:10px;font-weight:600;white-space:nowrap}
...
.not{font-size:10px;font-weight:600}
.section{font-weight:700;margin-top:2px;font-size:10px}
.ftr{text-align:center;margin-top:2px;font-size:10px;font-weight:600}
