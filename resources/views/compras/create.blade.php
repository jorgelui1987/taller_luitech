                ...
                <form action="{{ route('compras.store') }}" method="POST">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" id="fecha_estimada" class="form-control" name="fecha_estimada" value="{{ old('fecha_estimada') }}">
                        </div>
                        <div class="col-md-3">
                            <label for="descuento_general" class="form-label">Descuento general (S/)</label>
                            <input type="number" id="descuento_general" class="form-control" name="descuento_general" value="{{ old('descuento_general', 0) }}" min="0" step="0.01">
                        </div>
                    </div>
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <textarea id="notas" class="form-control" name="notas" rows="2" placeholder="Notas para la orden...">{{ old('notas') }}</textarea>
                    </div>
